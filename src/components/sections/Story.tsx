      ...
      <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <h2 className="font-display mt-4 text-4xl font-bold leading-tight md:text-6xl">
            Ancient remedies, <span className="text-accent text-glow-cyan">Awaken From The Dead.</span>
          </h2>
          <p className="mt-6 max-w-xl text-muted-foreground">
            Myco Wonderland is a small studio of herbalists, artists, and lab
            geeks formulating blends from inhouse-harvested mushrooms. Every batch is third-party tested. Every
